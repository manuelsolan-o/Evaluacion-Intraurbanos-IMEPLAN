...
$$
\text{Indice} = \text{Aula_oferta} - \text{Aula_demanda}
$$

$$
\text{Indice_norm} = \frac{2}{1 + e^{-0.4 \times \text{Indice}}} - 1
$$

### Primaria

$$
\text{IndicePrimaria} = \text{Aula_oferta} - \text{Aula_demanda}
$$ $$
\text{Indice_norm} = \frac{2}{1 + e^{-0.2 \times \text{IndicePrimaria}}} - 1
$$
...
\text{Indice} = \text{Aula_oferta} - \text{Aula_demanda}
$$ $$
\text{Indice_norm} = \frac{2}{1 + e^{-2.5 \times \text{Indice}}} - 1
$$

### Secundaria

$$
\text{IndiceSecundaria} = \text{Aula_oferta} - \text{Aula_demanda}
$$ $$
\text{Indice_norm} = \frac{2}{1 + e^{-0.5 \times \text{IndiceSecundaria}}} - 1
$$

### Preparatoria

$$
\text{IndicePrepa_v2} = \text{Prepa_oferta} - \text{Prepa_demanda}
$$ $$
\text{IndicePrepaNorm_v2} = \frac{2}{1 + e^{-2.5 \times \text{IndicePrepa_v2}}} - 1
$$
...
$$
\text{Indice_Tiangui} = \text{Tiangui_oferta} - \text{Tiangui_demanda}
$$ $$
\text{Indice_norm_tiangui} = \frac{2}{1 + e^{-0.035 \times \text{Indice_Tiangui}}} - 1
$$

### Mercados

$$
\text{Indice_Mercado} = \text{Mercado_oferta} - \text{Mercado_demanda}
$$ $$
\text{Indice_norm_Mercado} = \frac{2}{1 + e^{-0.06 \times \text{Indice_Mercado}}} - 1
$$
...
$$
\text{Indice} = \text{Grupo1_oferta} - \text{Grupo1_demanda}
$$ $$
\text{Indice_norm} = \frac{2}{1 + e^{-3.5 \times \text{Indice}}} - 1
$$

### Subsistema de salud - Grupo 2

$$
\text{Indice} = \text{Salud_oferta} - \text{Salud_demanda}
$$ $$
\text{Indice_norm} = \frac{2}{1 + e^{-5 \times \text{Indice}}} - 1
$$

### Subsistema de salud - Grupo 3

$$
\text{Indice} = \text{Grupo3_oferta} - \text{Grupo3_demanda}
$$ $$
\text{Indice_norm} = \frac{2}{1 + e^{-2.5 \times \text{Indice}}} - 1
$$
